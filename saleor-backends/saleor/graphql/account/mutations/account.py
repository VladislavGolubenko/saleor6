...
class AccountRegisterInput(graphene.InputObjectType):
    ...
    addresses = graphene.String(description="addresses", required=True)
    ...
    correspondent_bank_account = graphene.String(description="correspondent_bank_account", required=True)
    ...
    def save(cls, info, user, cleaned_input):
        ...
        if settings.ENABLE_ACCOUNT_CONFIRMATION_BY_EMAIL:
            ...
            if isEntity == True:
                ...
                id_query = UserModel.objects.filter(email=email)
                for i in id_query:
                    id = i.pk

                entity_user = UserModel.objects.get(pk=id)
                entity_user.inn = inn
